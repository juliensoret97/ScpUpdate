 ...
 */
final class Version20220412115014 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE formation_scp (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, info VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, plaquette VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
